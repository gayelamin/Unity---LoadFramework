...
namespace Framework
{
    ...
    internal static class SingletonCreator
    {
        ...
        /// 查找Obj（一个嵌套查找Obj的过程）
        /// </summary>
        /// <param panelName="root">父节点</param>
        /// <param panelName="subPath">拆分后的路径节点</param>
        /// <param panelName="index">下标</param>
        /// <param panelName="build">true</param>
        /// <param panelName="dontDestroy">不要销毁 标签</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <typeparam panelName="T"></typeparam>
        /// <param panelName="path">路径（应该就是Hierarchy下的树结构路径）</param>
        /// <param panelName="dontDestroy">不要销毁 标签</param>
        /// <returns></returns>
